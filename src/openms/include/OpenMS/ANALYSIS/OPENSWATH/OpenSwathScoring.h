  ...
  */
  ...
  void calculateDIAScores(OpenSwath::IMRMFeature* imrmfeature,
    ...
    */
     ...
     *
     *   - Case \#1: "simple" addition selected - Array of up to "nr_spectra_to_add" spectra returned (one more for an even value, see OpenSwath::ISpectrumAccess::getMultipleSpectra)
