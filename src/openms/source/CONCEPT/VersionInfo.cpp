...
#include <OpenMS/openms_build_info.h>
...
namespace OpenMS
{
  ...
  {
    static const std::string result = std::string(__DATE__) + ", " + __TIME__;
    return result;
  }
  ...
  std::string VersionInfo::getVersion()
  {
    static const std::string result = [] {
      std::string version = OPENMS_PACKAGE_VERSION;
  ...
  {
    static const VersionDetails result = VersionDetails::create(getVersion());
    return result;
  }

  std::string VersionInfo::getSourceRevision()
  {
    return OPENMS_SOURCE_REVISION;
  }

  bool VersionInfo::isSourceDirty()
  {
    return OPENMS_SOURCE_DIRTY;
  }

  std::string VersionInfo::getBuildInfo()
  {
    return OPENMS_BUILD_INFO;
  }
