...
# The SDK locates its versioned data from the loaded library after relocation.
file(RELATIVE_PATH CF_OPENMS_DATA_PATH_FROM_LIBRARY "/${INSTALL_LIB_DIR}" "/${INSTALL_SHARE_DIR}")
file(RELATIVE_PATH CF_OPENMS_DATA_PATH_FROM_EXECUTABLE "/${INSTALL_BIN_DIR}" "/${INSTALL_SHARE_DIR}")
