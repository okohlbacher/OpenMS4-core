...
{
  return OPENMS_GET_TEST_DATA_PATH("extracted_topp/THIRDPARTY/PercolatorAdapter_1.idXML");
}
...
START_SECTION([EXTRA] realistic idXML parity at library layer)
{
  ...
  else
  {
    ...
    const std::string idxml_path =
      OPENMS_GET_TEST_DATA_PATH("extracted_topp/THIRDPARTY/CometAdapter_4_out.idXML");
